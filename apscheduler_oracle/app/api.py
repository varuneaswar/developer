    ...
    def schedule_job():
        ...
        try:
            ...
            try:
                ...
                return jsonify({"error": f"Invalid run_date format: {str(e)}"}), 400
            ...
            if job_type == "bash":
                ...
                job_id = scheduler_mgr.add_bash_job(
                    job_id=job_id, script_path=script_path, run_date=run_date, args=args
                )
                ...
                return (
                    jsonify({"error": f'Invalid job_type: {job_type}. Must be "bash" or "python"'}),
                    400,
                )
    ...
    def remove_job(job_id: str):
        ...
        try:
            ...
            if success:
                ...
                return jsonify({"message": "Job removed successfully", "job_id": job_id}), 200
            else:
                return jsonify({"error": f"Job not found or could not be removed: {job_id}"}), 404
    ...
    def pause_job(job_id: str):
        ...
        try:
            ...
            if success:
                ...
                return jsonify({"message": "Job paused successfully", "job_id": job_id}), 200
            else:
                return jsonify({"error": f"Job not found or could not be paused: {job_id}"}), 404
    ...
    def resume_job(job_id: str):
        ...
        try:
            ...
            if success:
                ...
                return jsonify({"message": "Job resumed successfully", "job_id": job_id}), 200
            else:
                return jsonify({"error": f"Job not found or could not be resumed: {job_id}"}), 404
