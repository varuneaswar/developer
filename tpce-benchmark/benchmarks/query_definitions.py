...
class QueryDefinitions:
    ...
    def _register_queries(self) -> None:
        ...
        self.queries['I1'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'customer_id': 9_000_001, 'tax_id': 'TAXID9001',
                'status_id': 'ACTV', 'last_name': 'New', 'first_name': 'Customer',
                'middle': 'T', 'gender': 'M', 'tier': 1,
                'dob': date(1980, 1, 1), 'address_id': 1,
                'email1': 'new@example.com', 'email2': ''
            }
        )
        ...
        self.queries['I2'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'account_id': 9_000_001, 'broker_id': 1, 'customer_id': 1,
                'name': 'Test Account', 'tax_status': 1, 'balance': 10000.0
            }
        )
        ...
        self.queries['I3'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'trade_id': 9_000_001, 'dts': datetime.now(),
                'status_id': 'ACTV', 'trade_type_id': 'TMB',
                'is_cash': True, 'symbol': 'S00001', 'qty': 100,
                'bid_price': 45.0, 'account_id': 1, 'exec_name': 'ExecA',
                'trade_price': 45.0, 'charge': 10.0, 'commission': 5.0,
                'tax': 2.0, 'lifo': False
            }
        )
        ...
        self.queries['I4'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'account_id': 1, 'symbol': 'S00001',
                'dts': datetime.now(), 'trade_id': 9_000_001,
                'price': 45.0, 'qty': 100
            }
        )
        ...
        self.queries['I6'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'symbol': 'S00001', 'dts': datetime.now(),
                'price': 45.0, 'vol': 10000, 'ttl_seconds': 86400
            }
        )
        ...
        self.queries['I8'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'trade_id': 9_000_002, 'tags': {'equity', 'growth'},
        ...
        self.queries['I9'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'symbol': 'S00001', 'dts': datetime.now(),
                'price': 45.25, 'vol': 5000, 'ttl_seconds': 3600
            }
        )
        ...
        self.queries['I12'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'trades': [
                    {'trade_id': 9_000_010, 'account_id': 1, 'symbol': 'S00001',
                     'qty': 50, 'price': 45.0, 'dts': datetime.now()},
                    {'trade_id': 9_000_011, 'account_id': 1, 'symbol': 'S00002',
                     'qty': 25, 'price': 120.0, 'dts': datetime.now()},
                ]
            }
        )
        ...
        self.queries['I13'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'symbol': 'S00001', 'dts': datetime.now(),
                'price': 44.75, 'vol': 2500, 'timestamp_micros': 1_700_000_000_000_000
            }
        )
        ...
        self.queries['I14'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'account_id': 1, 'activity_type': 'trade',
                'count_increment': 1
            }
        )
        ...
        self.queries['I15'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'trade_id': 9_000_099, 'dts': datetime.now(),
                'status_id': 'ACTV', 'trade_type_id': 'TMB',
                'is_cash': True, 'symbol': 'S00001', 'qty': 200,
                'bid_price': 45.5, 'account_id': 1, 'exec_name': 'LWT_Exec',
                'trade_price': 45.5, 'charge': 10.0, 'commission': 5.0,
                'tax': 2.0, 'lifo': False
            }
        )
        ...
        self.queries['I16'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'customer_id': 9_000_003, 'tax_id': 'TAXID9003',
                'status_id': 'ACTV', 'last_name': 'Multi', 'first_name': 'Table',
                'middle': 'X', 'gender': 'F', 'tier': 2,
                'dob': date(1990, 6, 15), 'address_id': 2,
                'email1': 'multi@example.com', 'email2': 'multi2@example.com'
            }
        )
        ...
        self.queries['I17'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'account_id': 1, 'snap_date': date.today(),
                'snap_time': datetime.now(), 'account_name': 'Main Portfolio',
                'account_bal': 125000.0, 'symbol': 'S00001',
                'position_qty': 100, 'position_val': 4500.0
            }
        )
        ...
        self.queries['I19'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'watchlist_id': 9_000_001, 'customer_id': 1
            }
        )
        ...
        self.queries['I20'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'trade_id': 9_000_005, 'dts': datetime.now(),
                'status_id': 'SBMT', 'trade_type_id': 'TLB',
                'is_cash': False, 'symbol': 'S00002', 'qty': 300,
                'bid_price': 120.0, 'account_id': 2, 'exec_name': 'BatchExec',
                'trade_price': 119.5, 'charge': 12.0, 'commission': 8.0,
                'tax': 3.0, 'lifo': True
            }
        )
        ...
        self.queries['U4'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'symbol': 'S00001', 'dts': datetime.now(),
                'price': 46.25, 'open_price': 45.0, 'vol': 15000
            }
        )
        ...
        self.queries['U5'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'account_id': 1, 'new_balance': 60000.0, 'expected_balance': 50000.0
            }
        )
        ...
        self.queries['U7'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'customer_id': 1, 'new_email': 'updated@example.com'
            }
        )
        ...
        self.queries['U8'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'customer_id': 1, 'prefs_update': {'theme': 'dark', 'lang': 'en'}
            }
        )
        ...
        self.queries['U9'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'trade_id': 1, 'new_status': 'COMP', 'expected_status': 'PNDG'
            }
        )
        ...
        self.queries['U10'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'account_id': 1, 'name': 'Updated Account', 'tax_status': 2
            }
        )
        ...
        self.queries['U12'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'broker_id': 1, 'metric_name': 'total_trades', 'increment': 1
            }
        )
        ...
        self.queries['U14'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'account_id': 1, 'account_name': 'Premium Portfolio', 'account_bal': 130000.0
            }
        )
        ...
        self.queries['U15'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'trade_id': 1, 'new_status': 'COMP',
                'expected_status': 'PNDG', 'expected_type': 'TMB'
            }
        )
        ...
        self.queries['U16'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'account_id': 1, 'new_balance': 55000.0,
                'symbol': 'S00001', 'new_qty': 150
            }
        )
        ...
        self.queries['U17'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'trade_id': 1, 'tag': 'reviewed', 'ttl_seconds': 86400
            }
        )
        ...
        self.queries['U18'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'account_id': 1, 'new_balance': 70000.0,
                'expected_balance': 55000.0, 'expected_tax_st': 1
            }
        )
        ...
        self.queries['D2'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'account_id': 1, 'symbol': 'S00001',
                'dts': datetime(2024, 1, 1), 'trade_id': 9_000_001
            }
        )
        ...
        self.queries['D5'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'symbol': 'S00001', 'cutoff_dts': datetime(2023, 1, 1)
            }
        )
        ...
        self.queries['D9'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'trade_id': 9_000_001, 'timestamp_micros': 1_700_000_000_000_000
            }
        )
        ...
        self.queries['D14'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'watchlist_id': 1, 'symbols': ['S09997', 'S09998', 'S09999']
            }
        )
        ...
        self.queries['D16'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'watchlist_id': 1, 'symbols': ['S09991', 'S09992', 'S09993']
            }
        )
        ...
        self.queries['D19'] = QueryDefinition(
            ...
            params_generator=lambda: {
                'symbol': 'S99998', 'dts_list': [datetime(2023, 6, 1), datetime(2023, 6, 2)]
            }
        )
